...
resizeextra_lefthalf_keys = resizeextra_lefthalf_keys or {{"ctrl", "cmd", "alt"}, "left"}
...
resizeextra_righthalf_keys = resizeextra_righthalf_keys or {{"ctrl", "cmd", "alt"}, "right"}
...
resizeextra_fullscreen_keys = resizeextra_fullscreen_keys or {{"ctrl", "cmd", "alt"}, "up"}
...
resizeextra_fcenter_keys = resizeextra_fcenter_keys or {{"ctrl", "cmd", "alt"}, "down"}
...
resizeextra_center_keys = resizeextra_center_keys or {{"ctrl", "cmd", "alt"}, "return"}
